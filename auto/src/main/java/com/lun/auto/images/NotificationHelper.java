...
public class NotificationHelper {
    ...
    private void createChannel(String channelId, String channelName, int importance, boolean isShowBadge) {
        ...
        NotificationManager notificationManager = (NotificationManager) NiuApp.INS.getSystemService(NOTIFICATION_SERVICE);
    ...
    public NotificationCompat.Builder create(String channelId) {
        Context context = NiuApp.INS;

        return new NotificationCompat.Builder(context, channelId)
                .setContentTitle(context.getString(R.string.media_start))
                .setWhen(System.currentTimeMillis())
                .setSmallIcon(R.drawable.lun)
                .setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.drawable.lun));
    }
