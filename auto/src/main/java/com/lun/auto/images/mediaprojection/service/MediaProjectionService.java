package com.lun.auto.images.mediaprojection.service;
...
import com.lun.auto.images.mediaprojection.utils.FileUtils;
...
public class MediaProjectionService extends Service {
     ...
     * 创建 屏幕截图
     */
    private void createImageReader(boolean landscape) {
        int width;
        int height;
        if (landscape) {
     ...
     */
    public void createVirtualDisplay(int resultCode, Intent data, DisplayMetrics displayMetrics, boolean isScreenCaptureEnable, boolean isMediaRecorderEnable,boolean landscape) {
